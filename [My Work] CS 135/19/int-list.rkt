...
;; Purpose: If the given list is empty or has one element, it produces
;; true. If the function consumes 'ascending and the list is sorted in
;; ascending order, the function produces true. If the function consumes
;; descending and the list is sorted in descending order, the function produces
;; true. The function produces false otherwise.
;; Examples:
(check-expect (ascending-or-descending? (cons 0 (cons 2 (cons 3 empty))) 'ascending)
              true)
(check-expect (ascending-or-descending? (cons 4 (cons -5 (cons 6 empty))) 'ascending)
              false)
(check-expect (ascending-or-descending? (cons -7 (cons -8 (cons -9 empty))) 'descending)
              true)
